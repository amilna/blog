...
/**
 * BannerSearch represents the model behind the search form about `amilna\blog\models\Banner`.
 */
class BannerSearch extends Banner
{
    ...
    public function search($params)
    {
        ...
        $params = self::queryString([['title'],['description'],['image'],['front_image'],['tags'],['url']]);
		foreach ($params as $p)
		{
			$query->andFilterWhere($p);
		}
